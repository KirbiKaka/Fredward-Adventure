...
public class Level_1_1 extends Level {
    ...
    public Level_1_1(Player player) {
        super(player);
        sizeX = 1000;
        sizeY = 600;
    }
    ...
    public void init() {
        ...
        //Exits
        interactables.add(new Exit(50, 50, 950, 300, "Sprites/grassPathStoneTop.png", Level_2.getLevelID(), "Not too shabby for a random castle in the middle of nowhere.\nThe walkway really sells it."));
        interactables.add(new Exit(50, 50, 950, 350, "Sprites/grassPathStoneBottom.png", Level_2.getLevelID(), "Not too shabby for a random castle in the middle of nowhere.\nThe walkway really sells it."));
